...
public class SubscriptionService {
    ...
    public SubscriptionService(SubscriptionRepository subscriptionRepository, UserRepository userRepository, DeliveryTimeService deliveryTimeService) {
    ...
    public void addSubscription(SubscriptionRequest request){
        ...
        for(MealSlot slot:request.getMealSlots()){
            ...
            if(request.getDayOfWeek()!=null) subscription.setDayOfWeek(request.getDayOfWeek());
